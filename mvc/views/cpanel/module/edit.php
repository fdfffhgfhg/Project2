                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <input id="link" type="text" value="<?= $data['datas']['link'] ?>" class="form-control" name="data_post[link]">
                        </div>
                        <div class="form-group">
                            <label for="controller">Controller</label>
                            <input id="controller" type="text" value="<?= $data['datas']['controller'] ?>" class="form-control" name="data_post[controller]">
                        </div>
                        <div class="form-group">
                            <label for="icon">Icon</label>
                            <input id="icon" type="text" value="<?= $data['datas']['icon'] ?>" class="form-control" name="data_post[icon]">
                        </div>
                        <div class="form-group">
