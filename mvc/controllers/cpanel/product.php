...
class product extends controller
{
    ...
    public function index()
    {
        ...
        //  query join table
        //  phân trang ajax
        $rows = $this->ProductModels->select_array_join_table('tbl_product.*,tbl_category.name as name_cate',
        NULL,'tbl_product.id desc',
        NULL,NULL,
        'tbl_category','tbl_category.id = tbl_product.cateID','LEFT');
        ...
        $datas = [];
        if ($total_rows > 0) {
            $datas = $this->ProductModels->select_array_join_table('tbl_product.*,tbl_category.name as name_cate',
            NULL,'tbl_product.id desc',
            $start,$limit,
            'tbl_category','tbl_category.id = tbl_product.cateID','LEFT');
        }
    ...
    function pagination_page(){
        ...
        $this->view('cpanel/product/loadTable', $data);
    }
    function uploads(){
        if ($_FILES['file']['name']) {
